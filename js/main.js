...
const data = [
    ...
    { name: " Make an Enqiury ", url: "quote.html" },
    ...
    { name: " Clients Served by AfroBeta Consult", url: "index.html#clients" },

    { name: "Recent Posts About AfroBeta", url: "blog.html#recent" },
    ...
    { name: "What clients Say About us ", url: "testimonial.html" },
